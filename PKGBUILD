...
source=(
  ...
  "0001-feat-universal-provider-Add-one-click-sync-all-providers.patch"
)
...
prepare() {
  ...
  cd "${pkgname}-${pkgver}"
  patch -p1 -i "${srcdir}/0001-feat-universal-provider-Add-one-click-sync-all-providers.patch"
